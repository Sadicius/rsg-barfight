...
Config.SafeLocation = {x = -763.86, y = -1320.84, z = 51.46} -- Replace with actual safe coordinates
...
Config.AngryPeds = {
    ...
    number = 5,  -- Number of peds to spawn
    spawnRadius = 6.0,  -- Spawn radius around the fight location
